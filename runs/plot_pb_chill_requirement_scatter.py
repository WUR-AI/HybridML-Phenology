...
if __name__ == '__main__':
    ...
    # model_name_1 = model_cls_1.__name__ + '_final_japan_seed5_yedoensis'
    # model_name_2 = model_cls_2.__name__ + '_final_japan_seed18_yedoensis'
    ...
    # fn = 'plot_nn_chill_requirement_scatter.png'
    ...
    # ax.set_xlabel('DOY (Hybrid w. seed 1)')
    # ax.set_ylabel('DOY (Hybrid w. seed 2)')
