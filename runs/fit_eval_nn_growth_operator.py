...
from models.nn_chill_operator import NNGrowthModel
...
if __name__ == '__main__':
    ...
    run_name = 'Fit & Eval Torch NN Growth Operator'
    ...
    model_name = args.model_name or NNGrowthModel.__name__

    if args.skip_fit:
        model = NNGrowthModel.load(model_name)
    else:
        model, _ = fit_torch_model_using_args(NNGrowthModel,
                                              dataset,
                                              args,
                                              model_kwargs={
