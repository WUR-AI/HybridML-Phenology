...
from models.components.param_v3 import ParameterModel, FixedParameterModel
...
class BaseTorchAccumulationModel(BaseTorchModel):
    ...
    def __init__(self,
                 ...
                 parameter_model_slc: ParameterModel = None,
                 parameter_model_slg: ParameterModel = None,
                 loss_f: str = LOSSES[0],
        ...
        self._pm_slc = parameter_model_slc or FixedParameterModel(BaseTorchAccumulationModel.SLOPE_CHILL)
        self._pm_slg = parameter_model_slg or FixedParameterModel(BaseTorchAccumulationModel.SLOPE_GROWTH)
    ...
    def forward(self,
        ...
        return ix, {
            ...
            'ix_chill': (1 - (units_c_cs >= th_c).to(torch.int)).sum(dim=-1).clamp(min=0, max=Dataset.SEASON_LENGTH - 1),
